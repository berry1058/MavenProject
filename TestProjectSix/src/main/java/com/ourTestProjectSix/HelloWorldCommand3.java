package com.ourTestProjectSix;

import java.util.Calendar;

import com.ourTestProjectSix.model.SampleInput;
import com.ourTestProjectSix.model.SampleOutput;
...
@Route(uri="/hello/world3/{id}", method="POST", authenticated=false,
       inputKey="inputData", inputClass="com.ourTestProjectSix.model.SampleInput")
