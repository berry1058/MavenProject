...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "TestProject";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "TestProject.war")
            ...
            .addPackages(false, "com.ourTestProject") // not recursive to skip package 'nonarquillian'
